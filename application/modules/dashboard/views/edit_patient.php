	...
	<?php echo form_open(WEB_URL.'dashboard/editpatient?id='.$patient['patientid']);?>
	  	<div class="card shadow mb-4 valid-form">
		    ...
		    <?php
				...
				$waitingPeriod=array(
	            	1=>isset($plan['diagnostic_waitingperiod'])?$plan['diagnostic_waitingperiod']:'',
	            	2=>isset($plan['preventive_waitingperiod'])?$plan['preventive_waitingperiod']:'',
	            	3=>isset($plan['restorative_waitingperiod'])?$plan['restorative_waitingperiod']:'',
					    ...
					    <div class="row">
					        <div class="col-md-4 col-sm-12">
					            ...
					            <table class="table table-bordered disabled-input">
					                ...
					                <th>N</th>
					                <th style="width: 8%"><input type="radio" name="missing_tooth_clause" value="0" <?php echo isset($plan['missing_tooth_clause']) && $plan['missing_tooth_clause']=='0'?'checked':'' ?>></th>
					                </tr>
					                <tr>
					            ...
					            <table class="table table-bordered disabled-input">
					             ...
					             <table class="table table-bordered disabled-input">
					              <tr>
					                ...
					                <th>Times in</th>
					                <th style="width: 4%"><input type="text" name="procedure_level_single[]" class="form-control"  value="<?php echo isset($single[1208]['procedure_level_single'])?$single[1208]['procedure_level_single']:''?>"></th>
					                <th>
