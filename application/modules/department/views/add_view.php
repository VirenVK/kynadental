...
<div class="container-fluid">
	<!-- Page Heading -->
	<?php echo form_open(WEB_URL.'department/addDepartment',array('id'=>'myform'));?>
				...
				<div class="row">
					<div class="col-md-3 col-12">
						<div class="form-group">
							<label for="dept_short_name" class="col-form-label"> Department <span> *</span>
								<small data-toggle="tooltip" title="Code">
									<i class="fa fa-question-circle" aria-hidden="true"></i>
								</small>
							</label>
							<input type="text" class="form-control" id="dept_short_name" name="dept_short_name" placeholder="Code" value="<?php echo set_value('dept_short_name');?>">
					...
					<div class="col-md-3 col-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="name" name="name" placeholder="Department Name" style="text-transform: capitalize;" value="<?php echo set_value('name');?>">
