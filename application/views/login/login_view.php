          ...
          <div class="col-sm-8 col-md-6 col-lg-5 mx-auto">
            <div class="card card-signin border-0 shadow mt-5">
			  ...
			  <div class="row">
                ...
                <h5 class="card-title text-center mb-5 font-weight-light"><font style="font-size:25px;color:#2C78BC;">KYNA DENTAL | <b>Login</b></font></h5>
                <?php $this->load->view('theme/message_view');?>
				  <?php echo form_open(WEB_URL.'login/checkUserLogin');?>
                ...
                <div class="form-group mb-3">
                  <input type="password" class="form-control form-control-user pt-2 pb-2" id="exampleInputPassword" name="password" placeholder="Password">
                </div>
                ...
                <div class="text-center">
                  <a class="small btn btn-link btn-user btn-block font-weight-bold " href="<?php echo WEB_URL.'login/forgotPwd';?>">Forgot Password?</a>
                </div>
              </div>
            </div>
          </div>
